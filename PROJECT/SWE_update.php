...
<body>
    <?php 
        ...
        $ids= $_GET['sl_No'];
        $showquery= "select * from Software_Engineering where sl_No={$ids}";
        ...
        if(isset($_POST['submit']))
        {
            ...
            $update= " update Software_Engineering set sl_No=$id, 8:00am - 10:00am='$p1', 10:15am - 12:15pm='$p2', 12:15pm - 1:00pm='$p3', 1:00pm - 3:00pm='$p4', 3:15pm - 5:15pm='$p5' where sl_No=$id ";
                ...
                <table>
                    <thead>
                        <tr>
                            ...
                            <th bgcolor="yellow"><strong>3:15pm - 5:15pm</strong></th>
