    ...
    <div class="main-div">
        <div class="center-div">
            <div class="table-responsive">
                <table>
                <caption><h2>E-Commerce and Digital Marketing</h2></caption>
                    <thead>
                        <tr>
                    ...
                    <tbody>
                    <?php
                        $querry="select * from E_Commerce_and_Digital_Marketing ";
                        ...
                        while($res=mysqli_fetch_array($query)){
                           ?> 
                            ...
                            <td><a href="update1.php?sl_No=<?php echo $res['sl_No'];?>" data-toggle="tooltip" data-placement="bottom" title="Edit"><i class="fa fa-edit" aria-hidden="true"></i> </a></td>
                        </tr>
                        <?php
