...
<body>
    <?php 
        ...
        $ids= $_GET['sl_No'];
        $showquery= "select * from E_Commerce_and_Digital_Marketing where sl_No={$ids}";
        ...
        if(isset($_POST['submit']))
        {
            ...
            $qeryupdate="update E_Commerce_and_Digital_Marketing set sl_No=$id, 8:00am - 10:00am='$p1', 10:15am - 12:15pm='$p2', 12:15pm - 1:00pm='$p3', 1:00pm - 3:00pm='$p4', 3:15pm - 5:15pm='$p5' where sl_No=$id ";

            $res=mysqli_query($con,$qeryupdate);
            // echo $res ? 'good' : 'failed with ' . mysqli_error($con);
        ...
        <div class="center-div">
            <div class="table-responsive">
                ...
                <form action="" method="POST"  action="" enctype="multipart/form-data">    
                    <th>
                        <input type="text"  placeholder="1st Period" name="p1" value="<?php echo $arraydata['day']; ?>" readonly/>
                    </th>
                    <th>
